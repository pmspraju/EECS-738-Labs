...
results_dreg, learner_dreg = decTreeReg(Xr_train, yr_train, Xr_test, yr_test, 'entropy', 4)
...
print "R2 score for K Neighbhors regression -Training, Test sets: %.5f, %.5f" %(results_dreg['acc_train'], results_dreg['acc_test'])     
print "-----------------------------------------------------------------------"